...
/**
 * Create company offers/promotions for users
 * Admin only endpoint
 */
export async function POST(req: Request) {
  try {
    ...
    const {
      ...
      userIds = [],
      offerType = "promotion", // "promotion" | "discount" | "announcement" | "update"
    } = body
    ...
    return NextResponse.json({
      success: true,
      message: `Notifications created for ${successful} users`,
