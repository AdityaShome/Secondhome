...
import { Eye, EyeOff, Loader2, Home, Mail, Lock, User, ArrowRight, Phone } from "lucide-react"
...
export default function SignupPage() {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      await signIn("google", {
        callbackUrl: "/profile?tab=overview",
      })
    } catch (error) {
        ...
        <Card className="border-2 border-gray-200 shadow-xl">
          <CardContent className="p-8">
            <div className="space-y-6">
              ...
              {/* Show divider and Google button only on step 1 */}
              {step === 1 && (
                <>
                  {/* Divider */}
                  <div className="relative">
